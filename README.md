...
## 3. Decisiones de diseno del pipeline 
    ...
    Ej: limpiar_estructura() elimina la fila completamente nula 
    y los IDs duplicados. Sin esto, los totales de ventas 
    estarian inflados con registros fantasma. 
 
## 4. Conexion con [nombre del emprendimiento] 
